...
; Endereço inicial da ROM e tamanho (2 KiB = 2048 bytes, 0000H ~ 07FFH)
ROMBEGIN        EQU 0000H
ROMSIZE         EQU 800H

; Endereço inicial da RAM e tamanho (2 KiB = 2048 bytes, 2000H ~ 27FFH)
RAMBEGIN        EQU 2000H
RAMSIZE         EQU 800H

; Constantes de codificação para exibição de caracteres no display do CEDM-80
CHR_0           EQU 0C0H
CHR_1           EQU 0F9H
CHR_2           EQU 0A4H
CHR_3           EQU 0B0H
